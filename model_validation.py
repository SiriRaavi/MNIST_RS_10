...
train_data_dir = './data/mnist_10_as_2/train_data'
valid_data_dir = './data/mnist_10_as_2/valid_data'
# path to save the results
test_path = './saved_models/Results/'
