...
h5f = h5py.File('./saved_models/Results/test_Results.h5', 'r')
all_acc = h5f['all_acc_episode'][:]
loss = h5f['loss_episode'][:]
h5f.close()
...
plt.figure()
plt.plot(np.linspace(0, 500000, 21), movingaverage(loss, 500)[0:-1:10000],
...
fig = plt.figure()
for i in [0, 1, 4, 9]:
    line, = plt.plot(np.linspace(0, 500000, 21), acc_av[1:-1:10000, i], 'o',
